...
The primary key is created to differentiate items in a database from one another. It is essentially their definition that separates them from all other items. 
